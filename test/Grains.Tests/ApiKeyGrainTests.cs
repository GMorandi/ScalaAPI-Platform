...
public class ApiKeyGrainTests
{
    ...
    public async Task Validate_ActiveKey_ReturnsAuthResult()
    {
        ...
        await userGrain.Create(new UserCreate("user", 2, 60, [3001]));
        await userGrain.ApplyBalanceSnapshot(1, 50.0m);
    ...
    public async Task Validate_NormalizesOmittedIpLists()
    {
        ...
        await userGrain.Create(new UserCreate("user", 1, 0, []));
        await userGrain.ApplyBalanceSnapshot(1, 50.0m);
    ...
    public async Task Validate_PreservesDecimalPrecisionAcrossProjections()
    {
        ...
        await user.Create(new UserCreate("user", 1, 0, [3020]));
        await user.ApplyBalanceSnapshot(1, 123.45678901m);
    ...
    public async Task Validate_ExhaustedQuota_Throws()
    {
        ...
        await user.Create(new UserCreate("user", 1, 0, []));
        await user.ApplyBalanceSnapshot(1, 50.0m);
