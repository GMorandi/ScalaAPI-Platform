...
public sealed class MigrationSchemaTests
{
    ...
    public async Task TargetSchemaContainsPlatformProjectionAndMigrationColumns()
    {
        ...
        var required = new Dictionary<string, string[]>(StringComparer.Ordinal)
        {
            ...
            ["usage_logs"] = ["request_id", "lease_token", "api_key_id", "user_id", "account_id", "group_id", "model", "upstream_model", "input_tokens", "output_tokens", "cache_create_tokens", "cache_read_tokens", "cost_usd", "duration_ms", "first_token_ms", "stream", "client_disconnect", "input_image_count", "output_image_count", "image_size", "video_count", "video_resolution", "video_duration_seconds", "realtime_duration_ms", "realtime_frames", "disconnect_reason", "provider_usage_json", "reasoning_tokens", "service_tier", "upstream_endpoint", "cancellation_reason", "media_operation_id", "pricing_version", "created_at"],
            ...
            ["usage_events"] = ["lease_token", "request_id", "api_key_id", "user_id", "account_id", "group_id", "model", "upstream_model", "inbound_endpoint", "input_tokens", "output_tokens", "cache_create_tokens", "cache_read_tokens", "cost_usd", "duration_ms", "first_token_ms", "status_code", "stream", "client_disconnect", "input_image_count", "output_image_count", "image_size", "video_count", "video_resolution", "video_duration_seconds", "realtime_duration_ms", "realtime_frames", "disconnect_reason", "provider_usage_json", "reasoning_tokens", "service_tier", "upstream_endpoint", "cancellation_reason", "media_operation_id", "pricing_version", "created_at"],
            ...
            ["media_operations"] = ["operation_id", "idempotency_key", "operation_type", "status", "api_key_id", "account_id", "request_id", "lease_token", "upstream_task_id", "progress", "output_metadata", "error", "expires_at", "created_at", "updated_at", "request_fingerprint", "provider", "output_url", "content_type", "cancel_requested", "attempts", "next_poll_at", "last_polled_at"]
        };
