...
The latest completed vertical slice is the source-built provider-group gate
`scalaapi-provider-groups-0810l` (Platform `7c4836a`, Gateway `7b8b03c`).
...
At Platform/Admin Web/User Web `7c4836a` and Gateway `7b8b03c`:
