...
`scalaapi-responses-delete-0810` (Platform `28fdea1`, Gateway `d9638b4`). It includes
...
The `scalaapi-responses-delete-0810` run exercised the OpenAI Responses root
...
Remaining mutation semantics, provider-specific error fixtures, and live
adapters remain open.

At Platform/Admin Web/User Web `28fdea1` and Gateway `d9638b4`:
