...
- Gateway: 52 production C++ source/header files, 11 test source files, and 125
  CTest cases.
- Platform: 120 hand-written production C# files, 5 generated Cap'n Proto/global C# files, 65 test/benchmark C# files, and 243 passing tests: 69 Grain, 80 Host, 46 Admin, and 48 Provider mock tests.
...
- Garnet is the only distributed cache/projection service. Both products use
  ...
  override is selected; certificate rotation/expiry and partitioned multi-process
  convergence remain separate release gates.
...
- Garnet authentication, outage/reconnect, rebuild, invalidation flush, and the
  ...
  proven by Platform `bcf80e7`; certificate rotation/expiry, concurrent
