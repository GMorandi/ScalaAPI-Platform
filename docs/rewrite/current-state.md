...
- Product surface: 125 direct Admin API route declarations, 50 product tables,
  22 SQLSugar entity types, 25 Admin Web TypeScript/TSX files and 14 page views,
