...
- Garnet authentication, outage/reconnect, rebuild, invalidation flush, and the
  ...
  Garnet TLS image flags, certificate mounting/rotation, and concurrent
  multi-Gateway/multi-Silo ordering are not release gates yet.
