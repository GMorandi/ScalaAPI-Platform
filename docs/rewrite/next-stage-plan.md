...
The next stage starts from Platform/Admin Web `6549711`, User Web `6549711`, Gateway `3da0d33`, and read-only
...
Platform `6549711` extends the COM-01 native checkout boundary: migrations 038/039,
...
retry, provider selection, and idempotency conflict semantics. More production
adapters, refund-provider API reconciliation, exact-boundary crash injection, and
browser payment completion remain.
