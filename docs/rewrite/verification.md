...
The latest source snapshot is Platform/Admin Web/User Web `0134323` and Gateway
`418da3a`.
...
projection clearing. Restore/restart race coverage, per-item reconciliation,
and full MinIO lifecycle evidence remain open.
