...
The latest source snapshot is Gateway `cd475c7` and Platform `9fb449c`.
...
The current source-built project `scalaapi-policy-20260809h` exited zero.
...
The policy operations slice at Platform `9fb449c` adds migration 030. Admin rule
