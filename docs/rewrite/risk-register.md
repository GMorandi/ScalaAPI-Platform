...
| Media bytes lost or unauthorized | P0 | Partial | Provider polling copies bytes to MinIO, stores object key/ETag/size, and returns SigV4 presigned access; add deletion, metadata/object reconciliation, restore, and lifecycle cleanup tests |
