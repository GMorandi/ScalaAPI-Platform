...
provider_group_unknown_incidents=8
...
provider_fault_seed_response="$(admin_request POST /admin/seed/provider-mock-provider-fault-matrix '{}' \
    "$admin_token")"
assert_equals "16" "$(jq -er '.scenarios | length' <<<"$provider_fault_seed_response")" \
